...
<?php 
	...
	$query = "SELECT jual_rinci.nofaktur, jual_rinci.sales, jual_rinci.produk_id, jual_rinci.harga_jual, jual_rinci.harga_beli, jual_rinci.qty, jual_rinci.sisa_stok, jual_rinci.tgl_add, produk.nama FROM ( jual_rinci INNER JOIN produk ON jual_rinci.produk_id = produk.produk_id ) WHERE jual_rinci.id >0 $where"; 
?>
	...
	<div class="row pb-2">
		...
		<div class="col-sm pb-3">
			<div class="d-flex flex-column py-2 bg-warning px-3 rounded">
				<div class="col-sm text-white fw-bolder fs-1">
					<?php
						$query_qty = mysql_query("SELECT SUM( total_jual ) as uang FROM jual_rinci");
						$jumlah = mysql_fetch_object($query_qty);
